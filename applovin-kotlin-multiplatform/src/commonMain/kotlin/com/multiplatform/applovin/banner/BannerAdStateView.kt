...
/**
 * Renders the pre-loaded MAX standard Banner ad held by [adState].
 *
 * This composable does **not** call [loadAd] — the ad was already loaded inside
 * [rememberBannerAd]. Passing a pre-loaded [BannerAdState] ensures the native view
 ...
 * ```
 *
 * @param adState  pre-loaded state obtained from [rememberBannerAd].
